...
const PlaceOrder = () => {
  ...
  return (
    <form
      onSubmit={placeOrder}
      className="place-order flex-col lg:flex-row md:flex items-center justify-center gap-[50px] mt-[100px] "
    >
      ...
      <div className="place-order-right mt-[50px]">
        <div className="cart-total flex-1 flex flex-col gap-[20px] w-full min-w-80 mb-10 ">
          ...
          <div className="text-center">
            <button
              type="submit"
              className="text-orange-500 font-semibold border-[2px] border-orange-600 py-2 px-4 hover:bg-orange-600 hover:text-white hover:font-semibold rounded-lg items-center  text-center "
            >
              Proceed To Payment
            </button>
          </div>
